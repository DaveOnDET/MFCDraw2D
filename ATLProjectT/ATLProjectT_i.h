 ...
 */
/* Compiler settings for ATLProjectT.idl:
...
#ifndef __ATLProjectT_i_h__
#define __ATLProjectT_i_h__
...
#ifndef __IATLShape_FWD_DEFINED__
#define __IATLShape_FWD_DEFINED__
typedef interface IATLShape IATLShape;

#endif 	/* __IATLShape_FWD_DEFINED__ */
...
#ifndef __ATLShape_FWD_DEFINED__
#define __ATLShape_FWD_DEFINED__

#ifdef __cplusplus
typedef class ATLShape ATLShape;
#else
typedef struct ATLShape ATLShape;
#endif /* __cplusplus */

#endif 	/* __ATLShape_FWD_DEFINED__ */
...
#ifndef __IATLShape_INTERFACE_DEFINED__
#define __IATLShape_INTERFACE_DEFINED__

/* interface IATLShape */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IATLShape;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("220c2002-0896-46a1-b2ba-c0228a6749e5")
    IATLShape : public IDispatch
    {
    public:
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE TestAdd( 
            /* [in] */ FLOAT a,
            /* [in] */ FLOAT b) = 0;
        
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE SplitCirclePolygon180( 
            /* [in] */ LONG r,
            /* [in] */ LONG cx,
            /* [in] */ LONG cy,
            /* [out] */ LONG *pCoord) = 0;
    ...
    typedef struct IATLShapeVtbl
    {
        ...
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *SplitCirclePolygon180 )( 
            IATLShape * This,
            /* [in] */ LONG r,
            /* [in] */ LONG cx,
            /* [in] */ LONG cy,
    ...
    interface IATLShape
    {
        CONST_VTBL struct IATLShapeVtbl *lpVtbl;
    };
...
#define IATLShape_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IATLShape_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IATLShape_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IATLShape_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IATLShape_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IATLShape_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IATLShape_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define IATLShape_TestAdd(This,a,b)	\
    ( (This)->lpVtbl -> TestAdd(This,a,b) ) 

#define IATLShape_SplitCirclePolygon180(This,r,cx,cy,pCoord)	\
    ( (This)->lpVtbl -> SplitCirclePolygon180(This,r,cx,cy,pCoord) ) 
...
#endif 	/* __IATLShape_INTERFACE_DEFINED__ */



#ifndef __ATLProjectTLib_LIBRARY_DEFINED__
#define __ATLProjectTLib_LIBRARY_DEFINED__

/* library ATLProjectTLib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_ATLProjectTLib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("d36dca33-0ca4-4bba-83fb-7f2119c182b8")
CompReg;
#endif

EXTERN_C const CLSID CLSID_ATLShape;

#ifdef __cplusplus

class DECLSPEC_UUID("e3282751-55c4-405a-b290-b6acd22a316c")
ATLShape;
#endif
#endif /* __ATLProjectTLib_LIBRARY_DEFINED__ */
